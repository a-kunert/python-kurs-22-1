...
\console{Are you sure to continue? (y)es/(n)o}. 

Mögliche Antworten sind \console{yes}, \console{no} bzw. \console{y}, \console{n}. 
Daraufhin soll auf der Konsole \console{confirmed} oder \console{aborted} erscheinen. 
\end{block}
\end{frame}
